import { AudioFrame, AudioSource, LocalAudioTrack, Room, TrackPublishOptions, TrackSource, dispose, RoomEvent, TrackKind, AudioStream, DisconnectReason } from '@livekit/rtc-node';
...
export class AgentLiveKit extends System {
    ...
    postTick() { }
    start() { }
    async publishAudioStream(audioBuffer) {
    ...
    async convertToPcm(buffer, sampleRate = 48000) {
