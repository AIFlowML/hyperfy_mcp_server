...
async function getOrCreateSessionData() {
 ...
 */
async function initializeHyperfySession() {
    ...
    try {
        ...
        const baseAgentId = generateUUID({}, agentSeed);
        ...
        const worldId = generateUUID({}, `${runtime.agentId}-default-hyperfy`);
        ...
        runtime.getEntityById = async (entityId) => {
            try {
                // Cast the return type to match interface expectation
                return hyperfyService.getEntityById(entityId);
            }
            catch (error) {
        ...
        runtime.updateEntity = async (entity) => {
            try {
        ...
        const userId = generateUUID({}, `mcp-user-${baseAgentId}`);
        // Build session data that satisfies Record<string, unknown> constraint
        const sessionData = {
            worldId: worldId,
            userId: userId,
            playerState: {
                id: generateUUID({}, `player-${baseAgentId}`),
                name: 'HyperfyAgent',
...
function handleToolResult(result, toolName) {
    if (result.success) {
...
server.addTool({
    ...
    execute: async (args, context) => {
        ...
        const result = await chatTool.execute(args, toolContext);
...
server.addTool({
    ...
    execute: async (args, context) => {
        ...
        const result = await ambientTool.execute(args, toolContext);
...
server.addTool({
    ...
    execute: async (args, context) => {
        ...
        const result = await gotoTool.execute(args, toolContext);
...
server.addTool({
    ...
    execute: async (args, context) => {
        ...
        const result = await useTool.execute(args, toolContext);
...
server.addTool({
    ...
    execute: async (args, context) => {
        ...
        const result = await stopTool.execute(args, toolContext);
...
server.addTool({
    ...
    execute: async (args, context) => {
        ...
        const result = await unuseTool.execute(args, toolContext);
...
server.addTool({
    ...
    execute: async (args, context) => {
        ...
        const result = await walkRandomlyTool.execute(args, toolContext);
...
server.addTool({
    ...
    execute: async (args, context) => {
        ...
        const result = await getEmoteListTool.execute(args, toolContext);
...
server.addTool({
    ...
    execute: async (args, context) => {
        ...
        const result = await getWorldStateTool.execute(args, toolContext);
