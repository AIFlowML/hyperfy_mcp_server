 ...
 */
export const generateUUID = (_runtime, _seed) => {
    return uuidv4();
};
/**
 ...
 */
export const composePromptFromState = (memory, template) => {
 ...
 */
export async function processMessageWithAI(runtime, messageText, senderName, template) {
 ...
 */
export function createFastMCPEntity(agentId, fromId, senderName) {
    return {
        id: generateUUID({}, fromId.toString()),
        names: [senderName],
        agentId,
        metadata: {
 ...
 */
export function createFastMCPMemory(messageId, entityId, agentId, roomId, worldId, content) {
    return {
        id: messageId,
        content: {
            text: content.text || '',
 ...
 */
export function createWavHeader(dataLength, sampleRate = 48000, channels = 1, bitsPerSample = 16) {
 ...
 */
export function isValidTranscription(text) {
 ...
 */
export async function processVoiceTranscription(runtime, audioBuffer) {
    try {
 ...
 */
export async function generateAudioResponse(runtime, text) {
    try {
 ...
 */
export function createVoiceMemory(messageId, agentId, entityId, roomId, content) {
    return {
        id: messageId,
        agentId,
        entityId,
...
//# sourceMappingURL=eliza-compat.js.map