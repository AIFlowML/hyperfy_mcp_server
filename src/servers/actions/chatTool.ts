import { z } from 'zod';
import type { ChatParams, ActionResult, LogType, ChatSessionData } from '../../types/index.js';
...
Agent: "Sent message to Hyperfy: 'Currently exploring the eastern area, let me know if you're nearby!'"`,
  ...
  execute: async (
    ...
    const sessionData = session.data as ChatSessionData;
